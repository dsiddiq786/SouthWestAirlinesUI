...
export default function PassengerLastName({
  register,
  passenger,
  errors,
  clearErrors,
    ...
    <div className="flex flex-col">
      ...
      <div className="relative">
        <input
          ...
          {...register(`passengers.${passenger.passengerNo}.lastName`, {
            required: 'Enter last name',
          })}
          onChange={() =>
            clearErrors(`passengers.${passenger.passengerNo}.lastName`)
          } // Clear error on input change
          className={`h-[32px] w-[208px] rounded-sm py-[3px] pl-[7px] text-[13px] ${
            errors?.passengers?.[passenger.passengerNo]?.lastName
